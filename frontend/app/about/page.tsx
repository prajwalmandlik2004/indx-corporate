          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                Alpha is dedicated to transforming the way people learn and assess their knowledge. 
            ...
            <div className="relative">
              <div className="w-full h-96 bg-gradient-to-br from-green-400 to-emerald-500 rounded-3xl shadow-2xl flex items-center justify-center">
